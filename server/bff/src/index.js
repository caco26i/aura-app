...
/**
 * SPA posts Google credential (JWT) from @react-oauth/google after One Tap / button sign-in.
 * Establishes server session; Aura access token comes from GET /session.
 */
app.post('/auth/google', async (req, res) => {
  const errors = readConfigErrors();
  if (errors.length) {
...
/** Optional authorization-code flow when client secret + public URL are configured. */
