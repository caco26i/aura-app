...
| Clause | Verified in |
|--------|-------------|
| §4.1 Routes & shell | [`design/AURA_SCREEN_SPECS.md`](../../design/AURA_SCREEN_SPECS.md) (incl. deep links / `*` policy, **Modo Cita / Transporte / Check-in IA** wireframe subsection) + `web/src/App.tsx`, `AppShell.tsx`; wireframes en [`ModoCita.tsx`](../src/pages/ModoCita.tsx), [`ModoTransporte.tsx`](../src/pages/ModoTransporte.tsx), [`CheckinInteligente.tsx`](../src/pages/CheckinInteligente.tsx) |
