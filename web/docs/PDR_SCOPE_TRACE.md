...
| 2026-07-01 | [AURA-377](/AURA/issues/AURA-377): Wireframe / local-only routes API contract static sweep — **PASS** (post–[AURA-375](/AURA/issues/AURA-375)): no imports of `auraBackend.ts` / `auraBackendAuth.ts` and no `/v1/*` calls in [`Home.tsx`](../src/pages/Home.tsx), [`MapPage.tsx`](../src/pages/MapPage.tsx), [`Trusted.tsx`](../src/pages/Trusted.tsx), [`Welcome.tsx`](../src/pages/Welcome.tsx), or modo shells [`ModoCita.tsx`](../src/pages/ModoCita.tsx), [`ModoTransporte.tsx`](../src/pages/ModoTransporte.tsx), [`CheckinInteligente.tsx`](../src/pages/CheckinInteligente.tsx). `/map` uses OSM raster tiles only ([`AuraMap.tsx`](../src/components/AuraMap.tsx); documented in [BETA_BACKEND.md](./BETA_BACKEND.md)). Beta API surface remains on journey / SOS / BFF routes only ([`JourneyNew.tsx`](../src/pages/JourneyNew.tsx), [`JourneyActive.tsx`](../src/pages/JourneyActive.tsx), [`Emergency.tsx`](../src/pages/Emergency.tsx), [`Auth.tsx`](../src/pages/Auth.tsx), [`Settings.tsx`](../src/pages/Settings.tsx)) per [API_CONTRACT.md](./API_CONTRACT.md). Gap register unchanged. |
