...
**Product truth source:** [`docs/launch-narrative.md`](../launch-narrative.md), [`README.md`](../../README.md), [`PUBLIC_BETA.md`](../PUBLIC_BETA.md) — no new performance claims without CTO/CEO review.

**Pilot window:** **2026-04-09 → 2026-04-22** (two calendar weeks). First post **after** this schedule is committed in-repo.
...
## Published schedule (dates + hook + CTA)
...
## Post copy bank (drafts — align before publish)
...
**Post 5**  
For people leaders: Aura is a **lightweight web layer** employees can adopt beside existing wellness programs — **supportive**, not surveillant. Not a replacement for clinical care or emergency services.

**Post 6**  
For engineers supporting pilots: optional **authenticated beta API** + observability notes live in the repo — good for structured drills without overpromising outcomes.
